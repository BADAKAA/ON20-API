...
import { g as getSearchedElement, s as searchDate, c as clearDateSearch, r as resetSearch } from './searchElement-b8a9a033.js';
...
const DatePicker = class {
  ...
  ;
  render() {
    return (h(Host, null, h("div", { class: 'datePicker' }, h("div", { class: 'Header' }, h("span", { id: 'previous', onClick: () => changeYear('-') }, '<'), h("span", { id: 'year' }, year), h("span", { id: 'next', onClick: () => changeYear('+') }, '>')), h("div", { id: 'datePickerFrame' }))));
  }
