...
const ImageSlider = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { id: "slider-frame" }, index.h("img", { src: "./assets/pause.png", class: "sliderButton", id: "stopSliderButton" }), index.h("img", { src: "./assets/arrow.png", class: "sliderButton", id: "previousImageButton" }), index.h("img", { src: "./assets/arrow.png", class: "sliderButton", id: "nextImageButton" }), index.h("div", { id: "slider" })), index.h("slot", null)));
  }
  componentDidLoad() {
    initializeSlider();
  }
...
exports.image_slider = ImageSlider;
